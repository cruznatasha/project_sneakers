 ...
 * Favorites Model
 *
 * @property \App\Model\Table\SneakersTable&\Cake\ORM\Association\BelongsTo $Sneakers
...
class FavoritesTable extends Table
{
    ...
    {
        $rules->add($rules->existsIn('sneaker_id', 'Sneakers'), ['errorField' => 'sneaker_id']);
